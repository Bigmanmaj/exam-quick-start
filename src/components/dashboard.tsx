    ...
    <section className="mx-auto max-w-7xl px-5 pb-20 pt-9 sm:px-8">
      ...
      <section className="mt-10">
        ...
        <div className="mt-5 grid gap-5 sm:grid-cols-3">{recommendations.map((book) => <article key={book.id} className="flex flex-col rounded-lg border border-border bg-background p-5 shadow-warm transition hover:-translate-y-0.5 hover:shadow-warm-lg">
          ...
          <p className="mt-4 flex items-center gap-2 text-sm text-muted-foreground"><Clock3 size={16} /> {bookMinutes(book)} min of relevant chapters</p>
      ...
      {guest ? <section className="mt-12 rounded-lg border border-border bg-background p-6 sm:p-8">
        <h2 className="font-ui text-2xl font-bold">Sign up to save your revision plan</h2>
