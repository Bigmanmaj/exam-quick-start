...
export function JourneyFrame({children,back='/'}:{children:ReactNode;back?:'/'|'/results'}) {return <main className="min-h-screen bg-paper"><Header back={back}/><section className="mx-auto max-w-2xl px-5 pb-20 pt-10 sm:pt-16">{children}</section></main>}
